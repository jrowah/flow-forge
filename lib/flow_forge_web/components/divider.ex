defmodule FlowForgeWeb.Components.Divider do
  @moduledoc """
  The `FlowForgeWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `FlowForgeWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
