defmodule FlowForgeWeb.Components.Tabs do
  @moduledoc """
  `FlowForgeWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import FlowForgeWeb.Components.Badge, only: [badge: 1]
