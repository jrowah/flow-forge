defmodule FlowForgeWeb.Components.Chat do
  @moduledoc """
  `FlowForgeWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
