defmodule FlowForgeWeb.Components.Clipboard do
  @moduledoc """
  The `FlowForgeWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
