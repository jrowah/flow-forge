defmodule FlowForgeWeb.Components.CheckboxCard do
  @moduledoc """
  The `FlowForgeWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
