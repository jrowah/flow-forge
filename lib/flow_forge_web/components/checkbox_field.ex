defmodule FlowForgeWeb.Components.CheckboxField do
  @moduledoc """
  FlowForgeWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
