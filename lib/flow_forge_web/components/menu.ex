defmodule FlowForgeWeb.Components.Menu do
  @moduledoc """
  The `FlowForgeWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `FlowForgeWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import FlowForgeWeb.Components.Accordion, only: [accordion: 1]
  import FlowForgeWeb.Components.Button, only: [button_link: 1]
