defmodule FlowForgeWeb.Components.ScrollArea do
  @moduledoc """
  The `FlowForgeWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
